  ...
  useEffect(() => {
    const fetchGenres = async () => {
      try {
        ...
        setGenres(data.map((genre: { genre_name: number ; genre_id: string}) => ({ value: { genre_id: genre.genre_id, genre_name: genre.genre_name }, label: genre.genre_name })));
      } catch (error) {
            ...
            <div>
              ...
              <Select
                ...
                onChange={(selectedOptions) =>
                  setFavouriteGenres(selectedOptions.map((option) => option.value))
                }
              />
            </div>
            <div>
